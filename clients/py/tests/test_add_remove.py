...
from stake_pool.state import StakeStatus, ValidatorList


@pytest.mark.asyncio
async def test_add_remove_validators(
    async_client, validators, payer, stake_pool_addresses
):
    ...
    for validator_info in validator_list.validators:
        ...
        assert (
            validator_info.active_stake_lamports
            == stake_rent_exemption + LAMPORTS_PER_SOL
        )
